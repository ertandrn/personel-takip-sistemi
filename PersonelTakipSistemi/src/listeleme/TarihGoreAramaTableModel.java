...
public class TarihGoreAramaTableModel extends AbstractTableModel {
    ...
    public TarihGoreAramaTableModel(ResultSet rs) throws SQLException {
    ...
    public String[] sutunIsimleri = {"Ad", "Soyad", "İzin Bitiş Tarihi"};
    @Override
